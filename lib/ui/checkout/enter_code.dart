...
class _EnterCodeScreenState extends State<EnterCodeScreen> {
    ...
    child: Stack(
          children: [
            ...
            Container(
              ...
              child: button2(strings.get(278), /// "Apply code"
                  theme.mainColor, (){
  ...
  List<Widget> _child(){
    ...
    list.add(Text(strings.get(279),  /// "Your promo code",
    ...
    list.add(Container(
      ...
      child: edit42("",
        _editControllerCode,
        strings.get(280), /// "Enter code",
        onchange: (String value){
            var ret = isValidCodeForCard(value, true, _mainModel.currentService);
            _text = "";
            if (ret == "not_found")
