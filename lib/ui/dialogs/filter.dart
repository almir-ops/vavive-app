...
getBodyFilterDialog(Function() _redraw, Function() _close, MainModel _mainModel){
  ...
  return Column(
    ...
    children: [
      Center(child: Text(strings.get(34), /// "Filter",
          textAlign: TextAlign.center, style: theme.style14W800)),
      SizedBox(height: 10,),
      Text(strings.get(37), /// "Sort by",
      ...
      if (filterType != 2 && filterShowProviderInFilter)
        Row(
          children: [
            Text(strings.get(267), style: theme.style14W800,), /// Sort by provider
            Expanded(child: comboBoxProvider(
                strings.get(268), /// "Not select"
                    (String value){
                  if (filterType == 1)
      ...
      Row(
        children: [
          Expanded(child: button134(strings.get(36), (){ /// "Reset Filter",
            _resetFilter(_mainModel);
            _close();
            redrawMainWindow();
          }, style: theme.style14W800)),
          SizedBox(width: 10,),
          Expanded(child: button2(strings.get(35), /// "Apply Filter",
              theme.mainColor, (){
                applyFilter(_mainModel);
                _close();
              }))
...
_ascDescServiceItems(Function() _redraw){
  return Column(
    children: [
      Row(
        children: [
          Expanded(child: button2(strings.get(38), /// "Ascending (A-Z)",
          ...
          SizedBox(width: 10,),
          Expanded(child: button2(strings.get(39), /// "Descending (Z-A)",
      ...
      Row(
        children: [
          Expanded(child: button2(strings.get(225), /// "Nearby you",
          ...
          SizedBox(width: 10,),
          Expanded(child: button2(strings.get(226), /// "Far",
