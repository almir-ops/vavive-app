...
class _MapNearByScreenState extends State<MapNearByScreen> {
        ...
        child: Stack(
          children: <Widget>[
            ...
            appbar1(Colors.transparent,
                (theme.darkMode) ? Colors.white : Colors.black, strings.get(231), /// "Services nearby"
      ...
      list.add(Column(
        children: [
          Container(
            ...
            child: button202m(item, _mainModel, windowWidth*0.26, callback: (){
              _routeInit(item);
            })),
          SizedBox(height: 5,),
          Container(
            ...
            alignment: Alignment.bottomRight,
              child: button2c(strings.get(232), theme.mainColor, (){ /// Open Provider Page
  ...
  //   properties.add(DiagnosticsProperty('_iconDest', _iconDest));
  // }
