...
class SearchScreen extends StatefulWidget {
  ...
  const SearchScreen({Key? key, required this.close,}) : super(key: key);
...
class _SearchScreenState extends State<SearchScreen> with TickerProviderStateMixin{
    ...
    list.add(Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              // Text(strings.get(24), /// "Search",
              //   style: theme.style16W800,),
              // SizedBox(height: 3,),
              Text(strings.get(266), /// Find what you need
  ...
  _getProducts(){
    ...
    for (var item in productDataCacheSort) {
      list2.add(button202n2(item, windowWidth*0.3, strings.locale, strings.get(30), /// Not available Now
              () async {
...
filterParameters(int type, List<Widget> list, Function() _redraw, MainModel _mainModel){
  if (type == 1){ // service
    if (ascDescService == 1 || ascDescService == 2)
      list.add(filterItem(strings.get(37), /// "Sort by",
          ascDescService == 1 ? strings.get(38) : strings.get(39),  /// "Ascending (A-Z)", "Descending (Z-A)",
              (){
            ascDescService = 0;
            applyFilter(_mainModel);
            _redraw();
    ...
    if (ascDescService == 3 || ascDescService == 4)
      list.add(filterItem(strings.get(37), /// "Sort by",
          ascDescService == 3 ? strings.get(225) : strings.get(226),  /// "Nearby you", "Far",
              (){
            ascDescService = 0;
            applyFilter(_mainModel);
            _redraw();
    ...
    if (filterServiceProvider != "not_select")
      list.add(filterItem(strings.get(32), /// "Provider",
    ...
    if (isFilterPriceServiceModify())
      list.add(filterItem(strings.get(43), /// "Price",
  ...
  if (type == 2) { // provider
    if (ascDescProvider == 1 || ascDescProvider == 2)
      list.add(filterItem(strings.get(37), /// "Sort by",
          ascDescProvider == 1 ? strings.get(38) : strings.get(39),  /// "Ascending (A-Z)", "Descending (Z-A)",
              (){
            ascDescProvider = 0;
            applyFilter(_mainModel);
            _redraw();
    ...
    if (ascDescProvider == 3 || ascDescProvider == 4)
      list.add(filterItem(strings.get(37), /// "Sort by",
          ascDescProvider == 3 ? strings.get(225) : strings.get(226),  /// "Nearby you", "Far",
              (){
            ascDescProvider = 0;
            applyFilter(_mainModel);
            _redraw();
  ...
  if (type == 3) { // article
    if (articleAscDesc == 1 || articleAscDesc == 2)
      list.add(filterItem(strings.get(37), /// "Sort by",
          articleAscDesc == 1 ? strings.get(38) : strings.get(39),  /// "Ascending (A-Z)", "Descending (Z-A)",
              (){
            articleAscDesc = 0;
            applyFilter(_mainModel);
            _redraw();
    ...
    if (articleAscDesc == 3 || articleAscDesc == 4)
      list.add(filterItem(strings.get(37), /// "Sort by",
          articleAscDesc == 3 ? strings.get(225) : strings.get(226),  /// "Nearby you", "Far",
              (){
            articleAscDesc = 0;
            applyFilter(_mainModel);
            _redraw();
