    ...
    return [
                        ...
                        child: InkWell(
                            ...
                            child: Stack(
                              children: [
                                Hero(
                                    tag: _tag,
                                    child: showImage(currentArticle.gallery.isNotEmpty ? currentArticle.gallery[0].serverPath
                                        : "", fit: BoxFit.cover)),
                                Container(
        ...
        Row(
          children: [
            ...
            SizedBox(width: 10,),
            Text("${articleGetInStock()} ${currentArticle.unit} ${strings.get(260)}") ///  in stock
          ],
        ),
        SizedBox(height: 10,),
        ...
        Row(
          children: [
            Text(strings.get(95), /// "Total amount",
                style: theme.style12W800),
            SizedBox(width: 10,),
            Text(_price != null ? getPriceString(_price*currentArticle.countProduct) : strings.get(261), /// Please select variant
        ...
        Row(
          children: [
            Expanded(flex: 2, child: button2(strings.get(94), /// "Add to cart",
                theme.mainColor, (){
                  var ret = addToCart(currentArticle, strings.get(263)); /// This product already in the cart
                  if (ret != null)
                    messageError(context, ret);
                  else
                    messageOk(context, strings.get(262)); /// Product added to cart
                  redrawMainWindow();
